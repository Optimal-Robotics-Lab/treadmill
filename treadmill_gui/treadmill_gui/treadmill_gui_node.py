...
class TreadmillGUI(QMainWindow):
    ...
    def create_display_panel(self):
        ...
        self.plot_widget.setLabel(
            "left", "Speed", units="m/s", color="#00d9ff", **{"font-size": "12pt"}
        )
        self.plot_widget.setLabel(
            "bottom", "Time", units="s", color="#00d9ff", **{"font-size": "12pt"}
        )
        ...
        self.fill = self.plot_widget.plot(
            fillLevel=0, brush=pg.mkBrush(0, 217, 255, 30)
        )
